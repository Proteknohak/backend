...
from db.config import settings  # Добавили импорт нашего конфига
from db.database import Base  # Добавили импорт нашей мета-БД
from db.models import *  # Добавили импорт модели, чтобы она инициализировалась, но она не используется
